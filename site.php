<?php
	...
	$app->post( "/checkout", function(){
		...
		$order->setData( [
			...
			'vltotal'   => $cart->getCalculateTotal() + $cart->getvlfreight()
		] );
	...
	$app->get( "/boleto/:idorder", function( $idorder ) {
		...
		$valor_cobrado = formatPrice( $order->getvlrotal() ); // Valor - REGRA: Sem pontos na milhar e tanto faz com "." ou "," ou com 1 ou 2 ou sem casa decimal
